                ...
                <i class="fa fa-search"></i>
                    ...
                    <div class="col-md-6 my-auto">
                        ...
                        <li class="nav-item dropdown">
                                ...
                                <li><a class="dropdown-item" href="{{ route('customer.viewProductByLocation') }}"><i class=""></i> In {{ Auth::user()->location }}
</a></li>
                                <li><a class="dropdown-item" href="{{ route('customer.viewProduct') }}"><i class=""></i> All locations</a></li>
