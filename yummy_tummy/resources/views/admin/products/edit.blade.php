...
<html lang="en">
    ...
    <body>
        ...
        <div className="p-4">
            <form class="row g-3 p-10 m-10" method="POST" action="{{ route('admin.editProduct', $product->id) }}" enctype="multipart/form-data">
                @csrf
    ...
    @endif
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="category" name="category_tag" value='{{$product->food_category}}'>
                </div>
                <div class="col-md-2">
